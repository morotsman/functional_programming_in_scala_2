...
class FoldableTest extends FunSuite {
  ...
  test("testFoldLeft") {
    val prop = Prop.forAll(Gen.listOf(Gen.int))(l => {
      FoldableList.foldLeft(l)(List[Int]())((b, a) => a :: b) == l.reverse
    })
    Prop.run(prop, testCases = 100)
  ...
  test("testFoldRight") {
    val prop = Prop.forAll(Gen.listOf(Gen.int))(l => {
      FoldableList.foldRight(l)(List[Int]())((a, b) => a :: b) == l
    })
    Prop.run(prop, testCases = 100)
  }
  ...
  test("testFoldMap") {
    val prop = Prop.forAll(Gen.listOf(Gen.choose(1,100)))(l => {
      FoldableList.foldMap(l)(a => a)(Monoid.intAddition) == l.sum
    })
    Prop.run(prop, testCases = 100)
  }
  ...
  test ("productMonoid usage") {
    ...
    val prop1 = Prop.forAll(Gen.listOf(Gen.choose(1,10)))(l => {
      ...
      FoldableList.foldMap(l)(a => (a,a))(productMonoid) == (l.sum, l.fold(1)(_*_))
    })
    ...
    val prop2 = Prop.forAll(Gen.listOf(Gen.choose(1,10)))(l => {
      ...
      FoldableList.foldMap(l)(a => (1,a))(productMonoid) == (l.length, l.sum)
    })
